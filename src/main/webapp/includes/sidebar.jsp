<%--
    ...
    Final UI Fix:
    Sidebar content is placed inside .sidebar-scroll-area to prevent sidebar jamming
    when many menu items are visible.
...
<%
    ...
    /*
     * Keep unfinished modules hidden until Servlet + JSP are completed.
     */
...
<aside class="sidebar" id="sidebar">
    ...
    <!-- Brand: fixed top inside sidebar -->
